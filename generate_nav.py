...
def generate_html(tools, site_urls):
    ...
    all_tags = set()
    for tool in tools:
        all_tags.update(tool[5])  # tags 在第6位
...
<head>
    ...
    <!-- 资源预连接 - 加速第三方域名解析与连接 -->
    <link rel="dns-prefetch" href="https://events.vercount.one">
...
{tools_html}
    ...
    <!-- 小程序码弹窗 -->
    <div class="wxp-modal-overlay" id="wxpModalOverlay">
        <div class="wxp-modal">
    ...
    <!-- Vercount 访问统计 -->
    <script src="https://events.vercount.one/js" defer></script>
